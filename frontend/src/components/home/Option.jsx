    ...
    <div className="text-center h-full px-4 md:px-8 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto max-w-6xl">
        ...
        >
          ...
          />
          <h1 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white transition-all duration-150 cursor-pointer hover:text-slate-200 text-2xl md:text-3xl lg:text-4xl font-bold bg-black/50 p-2 rounded">
            Rent
          </h1>
        </motion.div>
